  ...
  <div class="task-list">
    <Top>
      <div class="top-left" slot="breadcrumb">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>
            <img class="appManage" src="@/assets/images/file.png" />新增教程
          </el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </Top>
    <div class="bottom">
      <el-form ref="form" :model="form" label-width="80px" class="bottom-form">
        ...
        <el-form-item label="教程详情：" class="editor">
...
<script>
import { addTutorial } from "@/api/appManagement/courseManagement/courseManagementList.js";
import { getTutorialTypeList } from "@/api/appManagement/courseManagement/courseManagementType.js";
