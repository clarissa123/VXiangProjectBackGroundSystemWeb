    ...
    <Top>
      <div class="top-left" slot="breadcrumb">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item :to="{name:'courseManagementList'}">
            <img class="appManage" src="@/assets/images/file-list.png" />教程管理
          </el-breadcrumb-item>
          <el-breadcrumb-item>
            <img class="appManage" src="@/assets/images/file.png" />编辑
          </el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </Top>
    <div class="bottom">
      <el-form ref="form" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
        :model="form" label-width="80px" class="bottom-form">
        <el-form-item label="主标题">
          <el-input v-model="form.mainTitle" class="input1"></el-input>
        </el-form-item>
        <el-form-item label="分类">
          <el-select class="select" v-model="form.typeId" clearable placeholder="请选择" @click.native="clickSelect">
        ...
        <el-form-item label="商品图片：">
          <el-upload class="bannerBg" :action="uploadActionUrl" :show-file-list="false"
            ...
            <div v-if="!form.imageUrl" class="uploadWen">尺寸：363px * 255px</div>
          </el-upload>
        </el-form-item>
        <el-form-item label="副标题">
          <el-input v-model="form.subTitle" class="input1"></el-input>
        </el-form-item>
        <el-form-item label="任务详情：" class="editor">
          <editor-bar v-model="form.content" :isClear="isClear" @change="change"></editor-bar>
        </el-form-item>
        <el-button class="btn ok-btn" @click="updateTutorial">保存</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async updateTutorial() {
        ...
        await updateTutorial(params).then(res => {
          if (res.code == 1) {
            this.reload();
            this.$message({
              message: "修改成功",
