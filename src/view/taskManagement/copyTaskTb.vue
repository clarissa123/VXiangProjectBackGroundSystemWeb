    ...
    <div class="bottom">
      <el-form ref="form" :model="form" label-width="80px" class="bottom-form">
        ...
        <el-form-item label="商品编号：">
          ...
          <span>商品返佣：</span>
          <span>{{form.commissonPrice}}</span>
        </el-form-item>
        <el-form-item label="商品链接：">
          <el-input v-model="form.materialUrl" class="input4"></el-input>
        ...
        <el-form-item label="商品图片：">
          <el-upload class="bannerBg" :action="uploadActionUrl" :show-file-list="false"
            :on-success="handleAvatarSuccess" :before-upload="beforeUploadVideo" :data="extraParams">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.form.commissionShare = (
        this.$route.params.row.commissionRate / 100
      ).toFixed(3);
      this.form.price = Number(this.$route.params.row.zkFinalPrice);
      this.form.commissonPrice = (
        this.form.commissionShare * this.form.price
      ).toFixed(3);
      this.form.id = this.$route.params.row.itemId;
      this.form.imgUrl = this.$route.params.row.pictUrl;
      this.form.materialUrl = this.$route.params.row.itemUrl;
      this.form.sellAmounts = this.$route.params.row.sellAmounts;
      this.form.skuName = this.$route.params.row.skuName;
    ...
    methods: {
      ...
      async addTask() {
        ...
        this.form.videoinfos.forEach((v, i) => {
          v.downloadTime = Number(v.downloadTime);
        });
        let params = {
          attribute:2,
          desc: this.form.desc,
