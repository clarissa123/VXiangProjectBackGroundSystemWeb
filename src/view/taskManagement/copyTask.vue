      ...
      <el-form ref="form" :model="form" label-width="80px" class="bottom-form">
        ...
        <el-form-item label="课程分类：">
          <el-select class="select" v-model="form.catgoryId" clearable placeholder="请选择"
            ...
            <el-option v-for="item in options" :disabled="form.type==''" :label="item.label" :key="item.value" :value="item.value"></el-option>
          </el-select>
        </el-form-item>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.form.commissionShare = (this.$route.params.row.commissionShare / 100).toFixed(3);
      this.form.commissonPrice = (this.form.commissionShare * this.$route.params.row.price).toFixed(3);
      this.form.id = this.$route.params.row.id;
      this.form.imgUrl = this.$route.params.row.imgUrl;
      this.form.materialUrl = this.$route.params.row.materialUrl;
      this.form.price = this.$route.params.row.price;
