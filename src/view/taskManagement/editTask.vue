  ...
  <div class="task-list">
    <Top>
      <div class="top-left" slot="breadcrumb">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>
            <img class="appManage" src="@/assets/images/file.png" />编辑课程
          </el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </Top>
    <div class="bottom">
      <el-form ref="form" :model="form" label-width="80px" class="bottom-form">
        ...
        <el-button class="btn ok-btn" @click="updateTask">保存</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async updateTask() {
        ...
        await updateTask(params).then(res => {
          if (res.code == 1) {
            this.reload();
            this.$message({
              message: "修改成功",
